...
CREATE DATABASE IF NOT EXISTS fydp_hub;
...
CREATE TABLE group_members (
    ...
    CONSTRAINT group_members_student_fk
...
CREATE TABLE projects (
    ...
    CONSTRAINT projects_group_fk
        FOREIGN KEY (group_id)
        REFERENCES `groups`(id)
        ON DELETE CASCADE,

    CONSTRAINT projects_supervisor_fk
        FOREIGN KEY (supervisor_teacher_id)
...
CREATE TABLE join_requests (
    ...
    CONSTRAINT join_requests_group_fk
        FOREIGN KEY (group_id)
        REFERENCES `groups`(id)
        ON DELETE CASCADE,

    CONSTRAINT join_requests_student_fk
        FOREIGN KEY (student_id)
        REFERENCES students(id)
        ON DELETE CASCADE
);
